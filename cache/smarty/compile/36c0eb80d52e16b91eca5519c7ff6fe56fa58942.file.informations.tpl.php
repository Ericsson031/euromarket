<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:43
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1390008616527b4a8b504160-39031776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '36c0eb80d52e16b91eca5519c7ff6fe56fa58942' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/informations.tpl',
      1 => 1380475270,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1390008616527b4a8b504160-39031776',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a8b94d213_61595129',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a8b94d213_61595129')) {function content_527b4a8b94d213_61595129($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
" <?php if ($_smarty_tpl->tpl_vars['product_type']->value==Product::PTYPE_SIMPLE){?>checked="checked"<?php }?> />
		...
		<input type="radio" name="type_product" id="pack_product" value="<?php echo Product::PTYPE_PACK;?>
" <?php if ($_smarty_tpl->tpl_vars['product_type']->value==Product::PTYPE_PACK){?>checked="checked"<?php }?> />
		...
		<input type="radio" name="type_product" id="virtual_product" value="<?php echo Product::PTYPE_VIRTUAL;?>
" <?php if ($_smarty_tpl->tpl_vars['product_type']->value==Product::PTYPE_VIRTUAL){?>checked="checked"<?php }?> />
		<label class="radioCheck" for="virtual_product"><?php echo smartyTranslate(array('s'=>'Virtual Product (services, booking and downloadable products)'),$_smarty_tpl);?>
</label>
	</div>
...
';
					var id_product_redirected = <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->id_product_redirected, 'html', 'UTF-8');?>
;
...
<br /></label>
					<p class="product_description">(<?php echo smartyTranslate(array('s'=>'appears in the product lists and on the top of the product page'),$_smarty_tpl);?>
)</p>
				</td>
				<td style="padding-bottom:5px;">
