<?php /* Smarty version Smarty-3.1.8, created on 2013-11-10 13:00:32
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/customers/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1872235826527f4b305fff06-05883771%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e42097f52ea441bea9a1bf9dcd0827788dda544d' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/customers/helpers/list/list_header.tpl',
      1 => 1380475342,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1872235826527f4b305fff06-05883771',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527f4b30b05132_71546060',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527f4b30b05132_71546060')) {function content_527f4b30b05132_71546060($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
" method="post">
			<div class="warn">
				<h2><?php echo smartyTranslate(array('s'=>'How do you want to delete your customer(s)?'),$_smarty_tpl);?>
</h2>
				<p><?php echo smartyTranslate(array('s'=>'You have two ways to delete a customer, please choose what you want to do.'),$_smarty_tpl);?>
</p>
				<ul class="listForm">
				<li>
					<input type="radio" name="deleteMode" value="real" id="deleteMode_real" />
					<label for="deleteMode_real" style="float:none;"><?php echo smartyTranslate(array('s'=>'I want to delete my customer(s) for real. All data will be removed from the database. A customer with the same e-mail address will be able to register again.'),$_smarty_tpl);?>
</label>
				</li>
				<li>
					<input type="radio" name="deleteMode" value="deleted" id="deleteMode_deleted" />
					<label for="deleteMode_deleted" style="float:none"><?php echo smartyTranslate(array('s'=>'I don\'t want my customer(s) to register again. The customer(s) will be removed from this list but all data will be kept in the database.'),$_smarty_tpl);?>
</label>
				</li>
				</ul>
...
<?php if ($_smarty_tpl->tpl_vars['submit_form_ajax']->value){?>
	<script type="text/javascript">
		$('#customer', window.parent.document).val('<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['new_customer']->value->email, ENT_QUOTES, 'UTF-8'), "HTML-ENTITIES", 'UTF-8');?>
');
