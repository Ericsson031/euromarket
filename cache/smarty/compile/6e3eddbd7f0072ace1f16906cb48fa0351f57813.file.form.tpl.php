<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:38
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1203594529527b4a865f14a5-55034856%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e3eddbd7f0072ace1f16906cb48fa0351f57813' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/helpers/form/form.tpl',
      1 => 1380475362,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1203594529527b4a865f14a5-55034856',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a875a9308_05135374',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a875a9308_05135374')) {function content_527b4a875a9308_05135374($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
;
		...
		var empty_pack_msg = '<?php echo smartyTranslate(array('s'=>'Pack is empty. You need to add at least one product to the pack before you can save the pack.','slashes'=>1),$_smarty_tpl);?>
';
		var empty_name_msg = '<?php echo smartyTranslate(array('s'=>'Product name is empty. You need to enter a name at least for the default language before you can save the product.','slashes'=>1),$_smarty_tpl);?>
';
		var empty_link_rewrite_msg = '<?php echo smartyTranslate(array('s'=>'Friendly URL is empty. You need to enter a friendly URL at least for the default language before you can save the product.','slashes'=>1),$_smarty_tpl);?>
';
		var reload_tab_title = '<?php echo smartyTranslate(array('s'=>'Confirmation','slashes'=>1),$_smarty_tpl);?>
';
		var reload_tab_description = '<?php echo smartyTranslate(array('s'=>'Some tabs was not loaded correctly, do you want to reload them?','slashes'=>1),$_smarty_tpl);?>
';
...
;
		...
		$(document).ready(function()
		{
			...
			$('.confirm_leave').live('click', function(){
				...
				return confirm("<?php echo smartyTranslate(array('s'=>'You will lose all unsaved modifications, do you want to proceed?','js'=>1),$_smarty_tpl);?>
");
			});
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:38
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_527b4a86f04c38_71891166')) {function content_527b4a86f04c38_71891166($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:39
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_category.tpl" */ ?>
<?php if ($_valid && !is_callable('content_527b4a870465a6_98443201')) {function content_527b4a870465a6_98443201($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home/eurobalk/public_html/tools/smarty/plugins/function.implode.php';
?>
