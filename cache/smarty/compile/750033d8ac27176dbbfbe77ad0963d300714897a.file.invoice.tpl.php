<?php /* Smarty version Smarty-3.1.8, created on 2013-10-28 11:43:25
         compiled from "/home/eurobalk/public_html/pdf/invoice.tpl" */ ?>
<?php /*%%SmartyHeaderCode:93185608526e159d8d2d57-22533714%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '750033d8ac27176dbbfbe77ad0963d300714897a' => 
    array (
      0 => '/home/eurobalk/public_html/pdf/invoice.tpl',
      1 => 1380484065,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '93185608526e159d8d2d57-22533714',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526e159dc76ea4_88151797',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526e159dc76ea4_88151797')) {function content_526e159dc76ea4_88151797($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/eurobalk/public_html/tools/smarty/plugins/function.cycle.php';
?>
...
?>
 ...
 <br /><?php echo smartyTranslate(array('s'=>'(Tax Excl.)','pdf'=>'true'),$_smarty_tpl);?>
					...
					<td style="background-color: #4D4D4D; color: #FFF; text-align: right; font-weight: bold; width: 10%">
						...
						<?php if ($_smarty_tpl->tpl_vars['tax_excluded_display']->value){?> 
							 <?php echo smartyTranslate(array('s'=>'','pdf'=>'true'),$_smarty_tpl);?>
<!--tax label removed-->
						<?php }else{ ?>
							 <?php echo smartyTranslate(array('s'=>'','pdf'=>'true'),$_smarty_tpl);?>
<!--tax label removed-->
					...
					<td style="background-color: #4D4D4D; color: #FFF; text-align: right; font-weight: bold; width: <?php if (!$_smarty_tpl->tpl_vars['tax_excluded_display']->value){?>15%<?php }else{ ?>25%<?php }?>">
						...
						<?php if ($_smarty_tpl->tpl_vars['tax_excluded_display']->value){?>
							<?php echo smartyTranslate(array('s'=>'','pdf'=>'false'),$_smarty_tpl);?>
<!--tax label removed-->
						<?php }else{ ?>
							<?php echo smartyTranslate(array('s'=>'','pdf'=>'false'),$_smarty_tpl);?>
<!--tax label removed-->
