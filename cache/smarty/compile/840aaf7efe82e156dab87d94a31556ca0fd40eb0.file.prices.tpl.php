<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:42
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1643506162527b4a8a88fc13-01920992%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '840aaf7efe82e156dab87d94a31556ca0fd40eb0' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/prices.tpl',
      1 => 1380475270,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1643506162527b4a8a88fc13-01920992',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a8acbf473_23841191',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a8acbf473_23841191')) {function content_527b4a8acbf473_23841191($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
" onchange="this.value = this.value.replace(/,/g, '.');" /><?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
			...
			<p class="preference_description"><?php echo smartyTranslate(array('s'=>'The wholesale price at which you bought this product'),$_smarty_tpl);?>
</p>
		</td>
	</tr>
...
<span id="unit_price_with_tax">0.00</span><?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
 ...
 <span id="unity_second"><?php echo $_smarty_tpl->tpl_vars['product']->value->unity;?>
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="on_sale" id="on_sale" style="padding-top: 5px;" <?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale){?>checked="checked"<?php }?> value="1" />&nbsp;<label for="on_sale" class="t"><?php echo smartyTranslate(array('s'=>'Display "on sale" icon on product page and text on product listing'),$_smarty_tpl);?>
</label>
		</td>
	</tr>
	<tr>
