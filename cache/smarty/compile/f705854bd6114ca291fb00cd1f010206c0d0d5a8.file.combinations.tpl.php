<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:45
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/combinations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1180089759527b4a8de7e319-73155505%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f705854bd6114ca291fb00cd1f010206c0d0d5a8' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/combinations.tpl',
      1 => 1380475269,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1180089759527b4a8de7e319-73155505',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a8e24dd80_51800318',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a8e24dd80_51800318')) {function content_527b4a8e24dd80_51800318($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
';
	var msg_combination_3 = '<?php echo smartyTranslate(array('s'=>'You can only add one combination per type of attribute'),$_smarty_tpl);?>
';
...
" /><span><?php echo smartyTranslate(array('s'=>'Product combinations generator'),$_smarty_tpl);?>
		...
		<?php echo smartyTranslate(array('s'=>'in order to create automatically a set of combinations'),$_smarty_tpl);?>

	<?php if ($_smarty_tpl->tpl_vars['combination_exists']->value){?>
	<div class="warn" style="display:block">
		<ul>
			<li><?php echo smartyTranslate(array('s'=>'Some combinations already exist. If you want to generate some new combinations, the quantities for the actual combinations will be lost.'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'You still can add a combination by clicking the link "Add new combination" on the toolbar.'),$_smarty_tpl);?>
</li>
		</ul>
	</div>
	<?php }?>
...
<?php }?>
						...
						<?php if ($_smarty_tpl->tpl_vars['currency']->value->format%2==0){?> <?php echo $_smarty_tpl->tpl_vars['currency']->value->sign;?>
<?php }?> 
						(<?php echo smartyTranslate(array('s'=>'overrides Eco-tax on "Information" tab'),$_smarty_tpl);?>
)
					</td>
				</tr>
			<?php }?>
...
" style="float: none;">
									<img src="<?php echo @_THEME_PROD_DIR_;?>
...
" />
			...
			<tr>
				...
				<td style="padding-bottom:5px;">
					...
					&nbsp;<?php echo smartyTranslate(array('s'=>'Make this the default combination for this product'),$_smarty_tpl);?>
<br /><br />
				</td>
			</tr>
			<tr>
