<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:46
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/quantities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:869275161527b4a8e7e1593-80181011%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '22eb0dd4f4ae7e871af4fa9d0d3cdcba2a6d33b7' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/quantities.tpl',
      1 => 1380475270,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '869275161527b4a8e7e1593-80181011',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a8ea4e4e5_20385119',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a8ea4e4e5_20385119')) {function content_527b4a8ea4e4e5_20385119($_smarty_tpl) {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['product']->value->id)){?>
	...
	<div class="hint" style="display:block; position:'auto';">
		<p><?php echo smartyTranslate(array('s'=>'This interface allows you to manage the available quantities for sale of the current product and its combinations on the current shop.'),$_smarty_tpl);?>
</p>
		...
		<p><?php echo smartyTranslate(array('s'=>'You can manually specify the quantities for the product/each product combination, or choose to automatically determine these quantities based on your stock (if advanced stock management is activated).'),$_smarty_tpl);?>
</p>
		<p><?php echo smartyTranslate(array('s'=>'In this case, the quantities correspond to the quantitites of the real stock in the warehouses associated to the current shop or current group of shops.'),$_smarty_tpl);?>
</p>
		<br/>
				...
				<tr <?php if ($_smarty_tpl->tpl_vars['product']->value->is_virtual||$_smarty_tpl->tpl_vars['product']->value->cache_is_pack){?>style="display:none;"<?php }?> class="stockForVirtualProduct">
					<td valign="top" style="vertical-align:top;">
						...
						<label style="float:none;font-weight:normal" for="depends_on_stock_1">
							<?php echo smartyTranslate(array('s'=>'Available quantities for current product and its combinations are based on stock in the warehouses'),$_smarty_tpl);?>
...
">
	...
	<?php }else{ ?>
		<div class="warn">
			...
			<ul>
				<li><?php echo smartyTranslate(array('s'=>'You are managing all shops.'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'You are managing a group of shops where quantities are not shared between all shops of this group.'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'You are managing a shop which is in a group where quantities are shared between all shops of this group.'),$_smarty_tpl);?>
</li>
			</ul>
		</div>
	<?php }?>
	...
	<table cellpadding="5">
		<?php if (!$_smarty_tpl->tpl_vars['ps_stock_management']->value){?>
				<tr>
					<td colspan="2"><?php echo smartyTranslate(array('s'=>'The stock management is disabled'),$_smarty_tpl);?>
</td>
				</tr>
			<?php }?>
 ...
 <>;=#{}<span class="hint-pointer">&nbsp;</span></span>
		...
		<tr>
			<td class="col-left">
				...
				<label><?php echo smartyTranslate(array('s'=>'Displayed text when allowed to be back-ordered:'),$_smarty_tpl);?>
</label>
			</td>
			<td style="padding-bottom:5px;" class="col-right">
