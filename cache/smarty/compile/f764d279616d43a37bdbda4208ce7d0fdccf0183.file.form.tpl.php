<?php /* Smarty version Smarty-3.1.8, created on 2013-11-12 19:57:46
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/request_sql/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199199290652824ffa1388c6-87606839%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f764d279616d43a37bdbda4208ce7d0fdccf0183' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/request_sql/helpers/form/form.tpl',
      1 => 1380475365,
      2 => 'file',
    ),
    '3073ab900f04b8cce57915320ed171678ac4e338' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form.tpl',
      1 => 1380475285,
      2 => 'file',
    ),
    '12824ff138b11696b847d630c96001bc3eb0a327' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_group.tpl',
      1 => 1380475285,
      2 => 'file',
    ),
    '824fc300a38536dcac3a21af074d149ef30a3351' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_category.tpl',
      1 => 1380475285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '199199290652824ffa1388c6-87606839',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52824ffb05c382_43128874',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52824ffb05c382_43128874')) {function content_52824ffb05c382_43128874($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '199199290652824ffa1388c6-87606839');
content_52824ffaad4bd7_78305170($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_category.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('categories'=>$_smarty_tpl->tpl_vars['input']->value['values']), 0, '199199290652824ffa1388c6-87606839');
content_52824ffab564a5_34459711($_smarty_tpl);
...
"><?php echo $_smarty_tpl->tpl_vars['p']->value['text'];?>
	...
	<br />
	<fieldset>
		<legend><?php echo smartyTranslate(array('s'=>'List of MySQL Tables:'),$_smarty_tpl);?>
</legend>
...
"><?php echo $_smarty_tpl->tpl_vars['table']->value;?>
			...
			<input type="button" id="add_table" value="<?php echo smartyTranslate(array('s'=>'Add table'),$_smarty_tpl);?>
" />
		</div>
...
',
				...
				success: function(data){
					var html = "<table class='table'>";
						html += "<thead>";
							html += "<tr>";
								html += "<th><?php echo smartyTranslate(array('s'=>'Attribute'),$_smarty_tpl);?>
</th>";
								html += "<th><?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
</th>";
								html += "<th><?php echo smartyTranslate(array('s'=>'Action'),$_smarty_tpl);?>
</th>";
							html += "</tr>";
						html += "</thead>";
						html += "<tbody>";
						for (var i=0; i < data.length; i++)
						{
							html += "<tr>";
								...
								html += "<td><input type=\"button\" class=\"add_attribute\" value=\"<?php echo smartyTranslate(array('s'=>'add attribute'),$_smarty_tpl);?>
\" onclick=\"javascript:AddRequestSql('"+data[i].Field+"');\"/></td>";
							html += "</tr>";
						}
						html += "</tbody>";
					html += "</table>";
		...
		$('#add_table').click(function(){
			...
			if (!table)
				jAlert("<?php echo smartyTranslate(array('s'=>'Please choose table.'),$_smarty_tpl);?>
");
			else
				AddRequestSql(table);
		});
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2013-11-12 19:57:46
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_52824ffaad4bd7_78305170')) {function content_52824ffaad4bd7_78305170($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2013-11-12 19:57:46
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/helpers/form/form_category.tpl" */ ?>
<?php if ($_valid && !is_callable('content_52824ffab564a5_34459711')) {function content_52824ffab564a5_34459711($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home/eurobalk/public_html/tools/smarty/plugins/function.implode.php';
?>
