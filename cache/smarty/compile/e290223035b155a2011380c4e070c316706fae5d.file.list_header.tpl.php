<?php /* Smarty version Smarty-3.1.8, created on 2013-11-26 22:53:35
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/backup/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21138834085294ee2f1ca548-91135057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e290223035b155a2011380c4e070c316706fae5d' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/backup/helpers/list/list_header.tpl',
      1 => 1380475334,
      2 => 'file',
    ),
    '92eba8b0fa36f39de51cce41b7ede0544cd1458b' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/helpers/list/list_header.tpl',
      1 => 1380475289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21138834085294ee2f1ca548-91135057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5294ee2f785614_09888456',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5294ee2f785614_09888456')) {function content_5294ee2f785614_09888456($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php echo smartyTranslate(array('s'=>'MB'),$_smarty_tpl);?>
				...
				<?php echo smartyTranslate(array('s'=>'Tip: You can also download this file over your FTP. Backup files are located in "admin/backups" directory.'),$_smarty_tpl);?>
</p>
		</fieldset><br /><br />
	<?php }?>
	...
	<div class="error width1" style="float: left; margin-right: 10px;">
		...
		<ol style="font-size: 11px; font-weight: normal; line-height: 20px; padding-left: 10px;">
			<li><?php echo smartyTranslate(array('s'=>'PrestaShop is not responsible for your database, Backups, data and recovery.'),$_smarty_tpl);?>
</li>
			...
			<li><?php echo smartyTranslate(array('s'=>'By default, your existing database tables will be dropped during Backup recovery (see "Backup options" below).'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Always verify the quality and integrity of your Backup files.'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Always verify that your Backup files are complete, up-to-date and valid, even if you had a success message during the Backup process.'),$_smarty_tpl);?>
</li>
...
" method="post" style="text-align:center;">
			<input type="submit" class="button" value="<?php echo smartyTranslate(array('s'=>'I have read the disclaimer - Create a new Backup'),$_smarty_tpl);?>
" style="padding:10px;font-weight:bold;border:1px solid;cursor:pointer;" />
	...
	<div class="warn width2" style="float: left;">
		...
		<ol style="font-size: 11px; font-weight: normal; line-height: 20px;">
			...
			<li><?php echo smartyTranslate(array('s'=>'Check the Backup integrity: look for errors, incomplete file, etc. Be sure to verify all your data.'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Ask your hosting provider for "phpMyAdmin" access to your database'),$_smarty_tpl);?>
</li>
			...
			<li><?php echo smartyTranslate(array('s'=>'At the top of the screen select the "Import" tab'),$_smarty_tpl);?>
</li>
			...
			<li><?php echo smartyTranslate(array('s'=>'Check the max. allowed filesize (e.g. Max: 16MB)'),$_smarty_tpl);?>
<br /><?php echo smartyTranslate(array('s'=>'If your Backup file exceeds this limit, contact your hosting provider'),$_smarty_tpl);?>
</li>
			<li><?php echo smartyTranslate(array('s'=>'Click on the "Go" button and wait during the import, the process can take several minutes'),$_smarty_tpl);?>
</li>
		</ol>
	</div>
