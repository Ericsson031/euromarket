<?php /* Smarty version Smarty-3.1.8, created on 2013-11-07 12:08:47
         compiled from "/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/virtualproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1547330039527b4a8f7f2226-77409923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b7289a1954a3a0f070b3059c7a5def235aa3f8c' => 
    array (
      0 => '/home/eurobalk/public_html/admin2013/themes/default/template/controllers/products/virtualproduct.tpl',
      1 => 1380475271,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1547330039527b4a8f7f2226-77409923',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527b4a8f9b5f35_39230211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527b4a8f9b5f35_39230211')) {function content_527b4a8f9b5f35_39230211($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/eurobalk/public_html/tools/smarty/plugins/modifier.escape.php';
?>
...
<h4><?php echo smartyTranslate(array('s'=>'Virtual Product (services, booking and downloadable products)'),$_smarty_tpl);?>
</h4>
...
" />
							<p class="preference_description"><?php echo smartyTranslate(array('s'=>'Your server\'s maximum upload file size is'),$_smarty_tpl);?>
...
" class="" size="6" />
							<p class="preference_description"><?php echo smartyTranslate(array('s'=>'Number of allowed downloads per customer - (Set to 0 for unlimited downloads)'),$_smarty_tpl);?>
</p>
						</td>
					</tr>
					<tr>
...
" size="11" maxlength="10" autocomplete="off" /> <?php echo smartyTranslate(array('s'=>'Format: YYYY-MM-DD'),$_smarty_tpl);?>
							...
							<p class="preference_description"><?php echo smartyTranslate(array('s'=>'If set, the file will not be downloadable anymore after this date. Leave this blank for no expiration date'),$_smarty_tpl);?>
</p>
						</td>
					</tr>
						<td class="col-left">
...
" class="" size="4" /><sup> *</sup>
							<p class="preference_description"><?php echo smartyTranslate(array('s'=>'How many days this file can be accessed by customers'),$_smarty_tpl);?>
 - <em>(<?php echo smartyTranslate(array('s'=>'Set to zero for unlimited access'),$_smarty_tpl);?>
				...
				<?php }else{ ?>
					<div class="hint clear" style="display: block;width: 70%;"><?php echo smartyTranslate(array('s'=>'You cannot edit your file here because you used combinations. Please edit it in the Combinations tab'),$_smarty_tpl);?>
</div>
					<br />
					<?php echo $_smarty_tpl->tpl_vars['error_product_download']->value;?>
