<?php /* Smarty version Smarty-3.1.14, created on 2014-04-09 01:54:37
         compiled from "/home/eurobalk/testing/themes/PRS050107/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17185977575344701d4a2b49-30474855%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3baf85ff2a89baadff2a1c7b2384c33e17ab4e7d' => 
    array (
      0 => '/home/eurobalk/testing/themes/PRS050107/product.tpl',
      1 => 1396991972,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17185977575344701d4a2b49-30474855',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5344701e72dfa2_52528312',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5344701e72dfa2_52528312')) {function content_5344701e72dfa2_52528312($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/eurobalk/testing/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/eurobalk/testing/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/eurobalk/testing/tools/smarty/plugins/function.counter.php';
?>
...
"<?php }else{ ?> title="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" onclick="$('span#wrapResetImages').hide('slow');return (false);"><?php echo smartyTranslate(array('s'=>'Display all pictures'),$_smarty_tpl);?>
		...
		<ul id="usefull_link_block">
			...
			<li> <div class="share-buttons share-buttons-panel" data-style="medium" data-counter="false" data-oauth="true" data-hover="true" data-promo-callout="bottom" data-buttons="twitter,facebook,pinterest" style="z-index:1">
...
?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
							...
							<li class="ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']){?>last_item<?php }else{ ?>item<?php }?> product_accessories_description">
									...
									<a style="float:left" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
<?php }?></span><?php }?>
								...
								<p class="clearfix" id="accessoriesbtn">
