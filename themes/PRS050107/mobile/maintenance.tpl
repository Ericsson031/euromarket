...
{/if}
	...
	<body>
		<div id="maintenance">
        	<div class="header">
            <h1><img src="{$img_dir}logo.png" alt="EuroBalkan Shop" title="EuroBalkan Shop"/></h1>
            </div>
            <div id="content">
                
            <br>
            <img src="{$img_dir}uc.png" alt="EuroBalkan Shop" title="EuroBalkan Shop"/>
            <br>
            <p id="message">
            ...
            <br>Icon II, Cluster L, Jumeirah Lake Towers, Dubai, U.A.E.
            <br>or call us: 04 3620 868
