...
<!-- =====================================/Products grid================================================== -->
	...
	{/if}
		...
		<li class="ajax_block_product {if $smarty.foreach.products.first}first_item{elseif $smarty.foreach.products.last}last_item{/if} {if $smarty.foreach.products.index % 2}alternate_item{else}item{/if} clearfix">
			<div class="prod_img">
			<!--<div class="top_block">-->
				<a  class="product_img_link" href="{$link->getImageLink($product.link_rewrite, $product.id_image, 'thickbox_default')}" title="{$product.name|escape:'htmlall':'UTF-8'}" >
					<img id="bigpic" class="jqzoom" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" {if isset($homeSize)} width="{$homeSize.width}" height="{$homeSize.height}"{/if}/>
                    <!--<img src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')}	" class="jqzoom" alt="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')}" id="bigpic" width="{$largeSize.width}" height="{$largeSize.height}" />-->
			...
			<div class="bottom_block">
                ...
                <div class="bottom_center">
                    <ul id="product-{$product.id_product}" class="favorites">
                          {$HOOK_SINGLELISTPRODUCT}
                    </ul>
                </div>
