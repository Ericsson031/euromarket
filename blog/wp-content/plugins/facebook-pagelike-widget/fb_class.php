...
class facebook_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="fb-like-box" data-href="'.$fb_url.'" data-width="'.$width.'" data-height="'.$height.'" data-colorscheme="'.$color_scheme.'" data-show-faces="'.$show_faces.'" data-stream="'.$show_stream.'" data-header="'.$show_header.'"  data-show-border="false" <!--data-border-color="'.$border.'"-->></div>';
        echo $after_widget;
    }
