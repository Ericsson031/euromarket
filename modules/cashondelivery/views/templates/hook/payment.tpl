...
<p class="payment_module">
		...
		<br />{l s='Pay with cash on delivery (COD)' mod='cashondelivery'}
        	<a class="button fltlft" href="{$link->getModuleLink('cashondelivery', 'validation', [], true)}" title="{l s='Pay with cash on delivery (COD)' mod='cashondelivery'}">Use this method »</a>
