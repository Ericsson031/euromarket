...
class Kohana_Image_GD extends Kohana_Image {
	...
	public static function check()
	{
		...
		if (defined('GD_BUNDLED'))
		{
			...
			Kohana_Image_GD::$_bundled = GD_BUNDLED;
		}
		else
		{
			...
			Kohana_Image_GD::$_bundled = (bool) preg_match('/\bbundled\b/i', $info['GD Version']);
		}
		...
		{
			throw new Kohana_Exception('Kohana_Image_GD requires GD version :required or greater, you have :version',
				array('required' => '2.0.1', ':version' => $version));
		}

		return Kohana_Image_GD::$_checked = TRUE;
	}
	...
	/**
	 * Runs [Kohana_Image_GD::check] and loads the image.
	 *
	 * @return  void
